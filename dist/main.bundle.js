...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  font-family: sans-serif;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-items: center;\n  background: #1a1a1a;\n}\n\ncanvas {\n  border: 3px solid brown;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,uBAAuB;AACzB;;AAEA;EACE,SAAS;EACT,UAAU;EACV,aAAa;EACb,YAAY;EACZ,aAAa;EACb,eAAe;EACf,uBAAuB;EACvB,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,uBAAuB;AACzB","sourcesContent":["html {\n  font-family: sans-serif;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  align-items: center;\n  background: #1a1a1a;\n}\n\ncanvas {\n  border: 3px solid brown;\n}\n"],"sourceRoot":""}]);
// Exports
...
var ctx = canvas.getContext("2d"); // on défini le nombre de colonne et rangée dans le canvas

var grid = 40; // on initialise la position du snake

var snake = [[9, 9], [9, 10], [9, 11]]; // on défini la pomme

var apple = [5, 5]; // on dessine la map
...
var updateSnakePosition = function updateSnakePosition() {
  var head = [snake[0][0], snake[0][1] + 1];
  snake.unshift(head);
  snake.pop();
};
